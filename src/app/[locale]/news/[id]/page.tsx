      ...
      <article className="bg-white dark:bg-neutral-900 p-8 rounded-xl border shadow-sm">
        <div className="flex justify-between items-center mb-6">
          <div className="text-sm text-gray-500 font-medium">
            {new Date(String(article.created_at)).toLocaleDateString("ru-RU")} •{" "}
            <span className="text-blue-600 bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full uppercase tracking-wider">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold mb-8 leading-tight">{String(article.title ?? "")}</h1>
